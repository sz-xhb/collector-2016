...
@Entity
@Table(name="data_elec_oil")
public class DataElecOil implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4185569346142771207L;
	...
	@Column(name="switch_time_1")
	private Date switchTime1;
	
	@Column(name="switch_type_1")
	private String switchType1;
	
	@Column(name="oil_kwh_total_1")
	private double oilKwhTotal1;
	
	@Column(name="elec_kwh_total_1")
	private double elecKwhTotal1;
	
	@Column(name="switch_time_2")
	private Date switchTime2;
	
	@Column(name="switch_type_2")
	private String switchType2;
	
	@Column(name="oil_kwh_total_2")
	private double oilKwhTotal2;
	
	@Column(name="elec_kwh_total_2")
	private double elecKwhTotal2;
	
	@Column(name="switch_time_3")
	private Date switchTime3;
	
	@Column(name="switch_type_3")
	private String switchType3;
	
	@Column(name="oil_kwh_total_3")
	private double oilKwhTotal3;
	
	@Column(name="elec_kwh_total_3")
	private double elecKwhTotal3;
	
	@Column(name="switch_time_4")
	private Date switchTime4;
	
	@Column(name="switch_type_4")
	private String switchType4;
	
	@Column(name="oil_kwh_total_4")
	private double oilKwhTotal4;
	
	@Column(name="elec_kwh_total_4")
	private double elecKwhTotal4;
	
	@Column(name="switch_time_5")
	private Date switchTime5;
	
	@Column(name="switch_type_5")
	private String switchType5;
	
	@Column(name="oil_kwh_total_5")
	private double oilKwhTotal5;
	
	@Column(name="elec_kwh_total_5")
