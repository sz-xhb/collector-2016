...
public class Meter_Mobile2 extends AbstractDevice {
...
//	private String time;
	...
	public Meter_Mobile2(ReceiptCollector receiptCollector, ReceiptMeter receiptMeter) {
	...
	private void analyzeFrame2(int[] data){
		...
		voltageAB = (data[79] * 256 + data[80]) / 10.0;
		voltageBC = (data[81] * 256 + data[82]) / 10.0;
		voltageAC = (data[83] * 256 + data[84]) / 10.0;
	}
