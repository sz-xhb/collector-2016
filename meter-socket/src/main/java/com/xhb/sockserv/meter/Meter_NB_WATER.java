 ...
 * @time 2016-04-12
 */
public class Meter_NB_WATER extends AbstractDevice {

	private double m3 = 0.0;

	public Meter_NB_WATER(ReceiptCollector receiptCollector, ReceiptMeter receiptMeter){
	...
	public boolean analyzeFrame(byte[] frame) {
		...
		m3  = (data[3] * 256 * 256 * 256 + data[4] * 256 * 256 + data[5] * 256 + data[6]) / 1.0;
	...
	public void handleResult() {
		...
		dw.setConsumption(m3);
		dw.setReadTime(new Date());
		dw.setReceiptCircuit(receiptCircuit);
